#%%
# Generate test data for the correct choice model (using monkey history inputs)
#
import sys
...
#%% Test with monkey history inputs for held-out trial indices
...
savename = project_root / f'{folder}/test_data/{name}_monkeyhist_alltestinds_noisevis{vis_noise}mem{mem_noise}rec{rec_noise}'
...
#%% Test on all data with monkey history inputs
N_testiters = 35
...
savename = project_root / f'{folder}/test_data/{name}_monkeyhist_allinds_noisevis{vis_noise}mem{mem_noise}rec{rec_noise}'
